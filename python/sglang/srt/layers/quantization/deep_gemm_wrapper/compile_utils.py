...
_ENABLE_JIT_DEEPGEMM_PRECOMPILE = envs.SGL_JIT_DEEPGEMM_PRECOMPILE
_DO_COMPILE_ALL = True
_IS_FIRST_RANK_ON_NODE = envs.SGL_IS_FIRST_RANK_ON_NODE
_COMPILE_WORKERS = envs.SGL_JIT_DEEPGEMM_COMPILE_WORKERS
_IN_PRECOMPILE_STAGE = envs.SGL_IN_DEEPGEMM_PRECOMPILE_STAGE
