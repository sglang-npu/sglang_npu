...
from petit_kernel import repack_nvfp4, process_nvfp4_scales, mul_fp4_a16
...
def prepare_fp4_layer_for_petit(layer: torch.nn.Module) -> None:
    ...
    # Permute scales
    weight_scale = process_nvfp4_scales(scales=layer.weight_scale, size_k=part_size_k, size_n=part_size_n)
...
def apply_petit_nvfp4_linear(
    ...
    output = mul_fp4_a16(a=reshaped_x,
                         b=weight,
                         s=weight_scale,
