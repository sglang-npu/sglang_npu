        ...
        if (
            ...
            if self.server_args.allow_auto_truncate:
                logger.warning(
                    ...
                    f"of {self.context_len} tokens. But auto-truncation is enabled, "
                    f"so the input will be truncated to fit within the limit."
                    f"You requested a total of {total_tokens} "
