...
def is_mla_backend(target_kv_pool) -> bool:
    ...
    from sglang.srt.mem_cache.memory_pool import AscendMLAPagedTokenToKVPool

    return isinstance(target_kv_pool, MLATokenToKVPool) or isinstance(target_kv_pool, AscendMLAPagedTokenToKVPool)
